...
versatilidad_df <- tibble(
  ...
  # AQUÍ OCURRE LA MAGIA: Unimos con la tabla de viajes
  left_join(viajes_distrito, by = c("distrito_asignado" = "distrito"))

# Verificación visual: ¿Aparece la columna ahora?
...
el coeficiente obtenido (0.003613297) es muy cercano a cero y no resulta
